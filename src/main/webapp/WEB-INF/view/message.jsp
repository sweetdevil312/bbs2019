...
<head>
    ...
    <title>Lhfly › <c:if test="${!empty userInfo}">${userInfo.username}</c:if><c:if test="${!empty errorInfo}">会员未找到</c:if></title>
</head>
<body>
<!-- 引入header文件 -->
...
<div style="width: 70%;margin:1% 2% 1% 5%;float: left;">
    <div class="panel panel-default" id="main" style="">
        <div class="panel-heading" style="background-color: white">
            <a href="/">Lhfly</a> › 消息列表 <span style="font-weight: bold">&nbsp;&nbsp;&nbsp;&nbsp;共有消息 ${messNum} 条，未读消息 ${unreadMessage} 条</span>
        </div>
